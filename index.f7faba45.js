...
y eleg\xed: piedra, papel o tijera antes de que pasen los 3 segundos.</div>
            ...
            `;let n=o.querySelector(".button-1");o.querySelector(".button-reset"),n&&n.addEventListener("click",()=>{d(`${l}/play`)}),e.appendChild(t),e.appendChild(o)}}customElements.define("my-text-field-step1",e)}(),function(){class e extends HTMLElement{constructor(){super(),this.render()}render(){let e,t;let o=this.attachShadow({mode:"open"}),n=document.createElement("style");n.innerHTML=`
                .root {
                    display: flex;
                    flex-direction: column;
                    align-items: center;
...
//# sourceMappingURL=index.f7faba45.js.map
