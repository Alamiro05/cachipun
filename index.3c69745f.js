var e=globalThis,t={},o={},n=e.parcelRequire5feb;function i(){let e=document.createElement("div");return e.innerHTML=`
    ...
    `,e}null==n&&((n=function(e){if(e in t)return t[e].exports;if(e in o){var n=o[e];delete o[e];var i={id:e,exports:{}};return t[e]=i,n.call(i.exports,i,i.exports),i.exports}var r=Error("Cannot find module '"+e+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(e,t){o[e]=t},e.parcelRequire5feb=n),(0,n.register)("27Lyk",function(e,t){Object.defineProperty(e.exports,"register",{get:()=>o,set:e=>o=e,enumerable:!0,configurable:!0});var o,n=new Map;o=function(e,t){for(var o=0;o<t.length-1;o+=2)n.set(t[o],{baseUrl:e,path:t[o+1]})}}),n("27Lyk").register(new URL("",import.meta.url).toString(),JSON.parse('["dZpbI","index.3c69745f.js","hbeyn","piedra.19124f4c.png","cnU0O","tijera.a939272c.png","5mdmA","papel.f0e8e201.png","57fgu","resultadoWin.282b81b6.png","79GE5","resultadoLoss.5074e4bf.png"]'));const l="/alamiro05.github.io";function c(e){console.log("El handle route recibió una nueva ruta:",e);let t=[{path:RegExp(`^${l}/rules`),component:i},{path:RegExp(`^${l}/play`),component:r},{path:RegExp(`^${l}/welcome`),component:a},{path:RegExp(`^${l}/scoreboard`),component:s}],o=document.querySelector(".content");if(o){o.innerHTML="";let n=!1;for(let i of t)if(i.path.test(e)){let e=i.component();o.appendChild(e),n=!0;break}n||(console.error("Ruta no encontrada:",e),d(`${l}/welcome`))}else console.error("No se encontró el elemento con la clase 'content'.")}function d(e){history.pushState({},"",e),c(e)}var p={};p=new URL("piedra.19124f4c.png",import.meta.url).toString();const m=new URL(p);var u={};u=new URL("tijera.a939272c.png",import.meta.url).toString();const g=new URL(u);var f={};f=new URL("papel.f0e8e201.png",import.meta.url).toString();const x=new URL(f),h=new URL(p),b=new URL(u),v=new URL(f),w=new URL(p),y=new URL(u),L=new URL(f);let S=Number(localStorage.getItem("userWins"))||0,E=Number(localStorage.getItem("computerWins"))||0;function H(){d(`${l}/rules`)}var R={};R=new URL("resultadoWin.282b81b6.png",import.meta.url).toString();const C=new URL(R);var $={};$=new URL("resultadoLoss.5074e4bf.png",import.meta.url).toString();const T=new URL($);!function(){class e extends HTMLElement{constructor(){super(),this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("style");t.innerHTML=`
            ...
            `;let n=o.querySelector(".button");n&&n.addEventListener("click",()=>{d(`${l}/rules`)}),e.appendChild(t),e.appendChild(o)}}customElements.define("my-text-field",e)}(),function(){class e extends HTMLElement{constructor(){super(),this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("style");t.innerHTML=`
                .root {
                    display: flex;
                    flex-direction: column;
                }
...
y eleg\xed: piedra, papel o tijera antes de que pasen los 3 segundos.</div>
            ...
            `;let n=o.querySelector(".button-1"),i=o.querySelector(".button-reset");n&&n.addEventListener("click",()=>{d(`${l}/play`)}),i&&i.addEventListener("click",()=>{localStorage.setItem("userWins","0"),localStorage.setItem("computerWins","0"),d(`${l}/play`)}),e.appendChild(t),e.appendChild(o)}}customElements.define("my-text-field-step1",e)}(),function(){class e extends HTMLElement{constructor(){super(),this.render()}render(){let e,t;let o=this.attachShadow({mode:"open"}),n=document.createElement("style");n.innerHTML=`
                .root {
                    display: flex;
                    flex-direction: column;
                    align-items: center;
            ...
            `;let i=document.createElement("div");i.classList.add("root"),i.innerHTML=`
                ...
                <div class="imagenes">
                    ...
                    <img src="${L}" alt="Papel" data-choice="Papel">
                    <img src="${y}" alt="Tijera" data-choice="Tijera">
                </div>
                <div class="resultado"></div>
            `;let r=i.querySelector("#countdown"),a=i.querySelector("#computer-choice"),s=null,c=null;t=2,e=setInterval(()=>{r&&(r.textContent=t.toString()),--t<0&&(clearInterval(e),s||H())},1e3);let p=i.querySelectorAll(".imagenes img");p.forEach(t=>{t.addEventListener("click",t=>{let o=t.target;if(o&&o.dataset.choice){if(s=o.dataset.choice,p.forEach(e=>{e.classList.add("disabled"),e.classList.remove("selected"),e.style.opacity="0.5"}),o.classList.add("selected"),o.style.opacity="1",r&&(r.style.display="none"),clearInterval(e),c=function(){let e=["Piedra","Papel","Tijera"];return e[Math.floor(Math.random()*e.length)]}(),a){let e=document.createElement("img");e.src=function(e){switch(e){case"Piedra":return w.toString();case"Papel":return L.toString();case"Tijera":return y.toString();default:return""}}(c),e.className="computer-choice-img",a.appendChild(e)}s&&c?setTimeout(()=>{var e,t,o,n;let i=(o=s)===(n=c)?"Empate":"Piedra"===o&&"Tijera"===n||"Papel"===o&&"Piedra"===n||"Tijera"===o&&"Papel"===n?(S++,localStorage.setItem("userWins",S.toString()),"Usuario"):(E++,localStorage.setItem("computerWins",E.toString()),"Computadora");e=s,t=c,localStorage.setItem("userChoice",e),localStorage.setItem("computerChoice",t),localStorage.setItem("winner",i),d(`${l}/scoreboard`)},2e3):H()}})}),o.appendChild(n),o.appendChild(i)}}customElements.define("game-page",e)}(),function(){class e extends HTMLElement{constructor(){super(),this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("style");t.innerHTML=`
                .root {
                    display: flex;
                    flex-direction: column;
                    align-items: center;
            ...
            `;let o=document.createElement("div");o.classList.add("root"),this.updateScoreboard(o);let n=o.querySelector(".button-back");n&&n.addEventListener("click",()=>{d(`${l}/rules`)}),e.appendChild(t),e.appendChild(o)}updateScoreboard(e){let t=Number(localStorage.getItem("userWins"))||0,o=Number(localStorage.getItem("computerWins"))||0,n=localStorage.getItem("winner"),i="Empate",r="",a="";n&&("Usuario"===n?(r="win",i="Ganaste",a=`<img class="win-image" src="${C}" alt="Ganaste">`):"Computadora"===n&&(r="lose",i="Perdiste",a=`<img class="lose-image" src="${T}" alt="Perdiste">`)),e.innerHTML=`
            <div class="root ${r}"> 
...
//# sourceMappingURL=index.3c69745f.js.map
